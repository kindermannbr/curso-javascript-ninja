...
console.log(varShowName); //[Function: showName]
...
function calculator(operator){
    return function(num1, num2){    //ATENÇÃO: para eu chamar uma função dentro de outra, preciso do return antes do "function"
        var resultado;
        switch(operator){
            case '+' :
                resultado = num1 + num2;
...
calculator('+')(1,2); //chamando a função
