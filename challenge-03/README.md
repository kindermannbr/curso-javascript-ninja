...
*/
var pessoa = {nome: 'Ricardo', sobrenome: 'Kindermann', sexo: 'Masculino', idade:  30, altura:  1.70, peso:  50, andando:  false, caminhouQuantosMetros:  0};
...
*/
pessoa.nomeCompleto();
//'Olá! Meu nome é Ricardo Kindermann'
...
pessoa.apresentacao = function(){
    var genero; //recebe a ou o. "eu sou o" ou "eu sou a"
    var ano; //recebe ano ou anos
    var qtdMetros; //recebe metros ou metro
...
pessoa.apresentacao();
/* 'Olá, eu sou a Ellen Kindermann, tenho 1 ano, 1.7, meu peso é 50 e, só hoje, eu já caminhei 1 metro!' */
```
